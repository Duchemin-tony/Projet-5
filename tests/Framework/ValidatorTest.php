...
class ValidatorTest extends TestCase
{
    ...
    {
        $this->assertCount(0, $this->makeValidator(['date' => '2018-12-12 11:12:13'])->dateTime('date')->getErrors());
        $this->assertCount(0, $this->makeValidator(['date' => '2018-12-12 00:00:00'])->dateTime('date')->getErrors());
        $this->assertCount(1, $this->makeValidator(['date' => '2018-21-12'])->dateTime('date')->getErrors());
        $this->assertCount(1, $this->makeValidator(['date' => '2018-02-29 11:12:13'])->dateTime('date')->getErrors());
    }
